    ...
    <main className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800">
      ...
      <section className="bg-gradient-to-b from-[#0b3c96] to-[#041d57] text-white pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center space-y-6 relative z-10">
          <Breadcrumbs
            theme="dark"
            items={[{ label: "Home", href: "/" }, { label: "Compliance", href: "/compliance" }, { label: "Section 508 & 504" }]}
          />
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 rounded-full text-xs font-bold uppercase tracking-wider text-blue-200 border border-white/15">
            U.S. Federal Rehabilitation Act
          </div>
          <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-tight">
            Section 508 &amp; 504 <span className="text-[#C8FF4D]">Federal Compliance</span>
          </h1>
          <p className="text-slate-200 text-lg md:text-xl font-light max-w-2xl leading-relaxed">
            Ensure public sector accessibility for government agencies, contractors, universities, and healthcare recipients of federal funding.
          </p>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-3">
            <span className="text-xs font-black tracking-widest text-blue-600 uppercase">Government Mandate</span>
            <h2 className="text-3xl font-black text-slate-900">Understanding Section 508 Requirements</h2>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
              <h4 className="font-extrabold text-slate-900">Federal Procurement</h4>
              <p className="text-xs text-slate-600 leading-relaxed">Government agencies cannot procure software, SaaS, or web services without a verified VPAT (Voluntary Product Accessibility Template).</p>
            </div>
            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
              <h4 className="font-extrabold text-slate-900">Higher Education &amp; Healthcare</h4>
              <p className="text-xs text-slate-600 leading-relaxed">Institutions receiving Title IV funding or federal grants must ensure learning portals, syllabi, and websites are fully accessible.</p>
            </div>
          </div>
        </div>
      </section>
