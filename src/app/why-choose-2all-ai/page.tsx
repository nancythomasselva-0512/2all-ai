...
export default function WhyChoose2allAiPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 flex flex-col font-sans select-none">
      ...
      {/* ── 1. BLUE HERO HEADER ── */}
      <section className="bg-gradient-to-b from-[#0b3c96] to-[#041d57] text-white pt-2 pb-10 md:pt-3 md:pb-14 px-6 md:px-12 lg:px-16 relative overflow-hidden shrink-0">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 text-left mb-4">
          <Breadcrumbs 
            theme="dark" 
          ...
          <h1 className="text-3xl md:text-5xl font-black tracking-tight leading-tight text-center">
            ...
            <div className="pt-3">
              <button
                ...
                className="bg-white hover:bg-slate-100 text-[#041d57] px-7 py-3 rounded-full font-black text-sm tracking-widest uppercase transition-all hover:scale-105 shadow-xl"
              >
                Compare Us &rarr;
              </button>
            </div>
      ...
      <section className="py-12 md:py-16 px-6 md:px-12 lg:px-16 bg-white relative">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            ...
            <ul className="space-y-3 pt-1">
              {[
                ...
                <li key={idx} className="flex items-start gap-3">
                  ...
                  <span className="text-slate-600 font-semibold text-xs md:text-sm">{bullet}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="bg-slate-50 rounded-[32px] border border-slate-100 p-7 shadow-xl relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-6 shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="relative w-7 h-7 flex items-center justify-center">
                        <svg className="w-full h-full transform -rotate-90">
                          <circle cx="14" cy="14" r="11" className="stroke-slate-200 fill-none" strokeWidth="2" />
                          <circle cx="14" cy="14" r="11" className="stroke-emerald-500 fill-none" strokeWidth="2.5" strokeDasharray="69" strokeDashoffset={69 - (69 * metric.ours) / 10} />
                        </svg>
                        <span className="absolute text-[7.5px] font-black text-emerald-600 font-mono">{metric.ours}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="relative w-7 h-7 flex items-center justify-center">
                        <svg className="w-full h-full transform -rotate-90">
                          <circle cx="14" cy="14" r="11" className="stroke-slate-200 fill-none" strokeWidth="2" />
                          <circle cx="14" cy="14" r="11" className="stroke-slate-400 fill-none" strokeWidth="2.5" strokeDasharray="69" strokeDashoffset={69 - (69 * metric.theirs) / 10} />
                        </svg>
                        <span className="absolute text-[7.5px] font-black text-slate-500 font-mono">{metric.theirs}</span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-12 md:py-16 px-6 md:px-12 lg:px-16 bg-slate-50/50 border-y border-slate-100 text-center">
        <div className="max-w-4xl mx-auto flex flex-col items-center space-y-8">
          
          <div className="space-y-3">
            <span className="text-xs font-black tracking-widest text-[#0b3c96] uppercase">Compliance Support</span>
            <h2 className="text-2xl md:text-4xl font-black text-slate-900 tracking-tight">Comprehensive Accessibility Alignment</h2>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
            {complianceBadges.map((badge, idx) => (
              <div key={idx} className="flex flex-col items-center space-y-2 bg-white p-5 rounded-[20px] border border-slate-200/80 shadow-sm w-32 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-600">
                  <Shield className="w-5 h-5" />
                </div>
                <h4 className="text-xs font-black text-slate-800 tracking-tight">{badge.name}</h4>
                <span className="text-[7px] text-slate-400 font-medium leading-relaxed block">{badge.desc}</span>
              </div>
            ))}
          </div>
          ...
          <div>
            <button
              onClick={() => setShowDemo(true)}
              className="bg-[#0b3c96] hover:bg-[#082d70] text-white px-7 py-3 rounded-full font-black text-xs tracking-widest uppercase transition-colors shadow-lg"
            >
      ...
      <section className="py-12 md:py-16 px-6 md:px-12 lg:px-16 bg-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative rounded-[32px] overflow-hidden border border-slate-200 shadow-2xl bg-slate-950 aspect-[16/10] flex items-center justify-center">
            ...
            <div className="p-6 text-left w-full h-full flex flex-col justify-between text-white font-mono text-[10px]">
              ...
              <div className="flex-grow flex flex-col justify-center space-y-2.5 py-4">
              ...
              <div className="border-t border-slate-800 pt-2.5 flex justify-between text-slate-500 text-[8px]">
          ...
          <div className="space-y-5 text-left">
            ...
            <h2 className="text-2xl md:text-4xl font-black text-slate-900 tracking-tight">Tailored solutions, simplified.</h2>
      ...
      <section className="py-12 md:py-16 px-6 md:px-12 lg:px-16 bg-slate-50 border-t border-slate-100">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-2">
            ...
            <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight">Automated, Continuous Accessibility</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className={`bg-gradient-to-br ${card.bg} border rounded-[28px] p-7 text-left flex flex-col justify-between h-[210px] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white`}>
                <div className="space-y-3">
                  <h4 className="text-base font-black text-slate-800 tracking-tight leading-snug">{card.title}</h4>
      ...
      <section className="py-12 md:py-16 px-6 md:px-12 lg:px-16 bg-[#070b13] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-5 text-left">
            ...
            <div>
              <button
                onClick={() => setShowDemo(true)}
                className="bg-white hover:bg-slate-100 text-[#070b13] px-7 py-3 rounded-full font-black text-xs tracking-widest uppercase transition-colors shadow-lg"
              >
                View Documentation
              </button>
            </div>
          ...
          <div className="bg-[#0B1220]/60 border border-slate-800/80 rounded-[28px] p-5 backdrop-blur-md shadow-2xl relative text-left">
            <div className="flex items-center gap-1.5 border-b border-slate-800/50 pb-2.5 mb-3">
            ...
            <pre className="text-[10px] text-[#7FD8FF] font-mono leading-relaxed overflow-x-auto">
...
console.log('✓ 2all.ai active - DOM sweep initialized');`}
      ...
      <section className="pb-12 md:pb-16 px-6 md:px-12 lg:px-16 bg-white">
        <div className="max-w-7xl mx-auto bg-gradient-to-br from-[#0b3c96] to-[#041d57] rounded-[32px] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden text-white shadow-2xl">
          ...
          <div className="relative z-10 shrink-0">
            <button
              onClick={() => setShowDemo(true)}
              className="bg-white hover:bg-slate-100 text-[#041d57] px-7 py-3 rounded-full font-black text-xs tracking-widest uppercase transition-all hover:scale-105 shadow-xl"
            >
              Start Free Trial
            </button>
          </div>
