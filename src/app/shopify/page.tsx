...
export default function ShopifyIntegrationPage() {
  ...
  const snippet = `<!-- 2all.ai Accessibility Widget for Shopify -->
<script 
    ...
    <main className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800">
      ...
      <section className="bg-gradient-to-b from-[#0b3c96] to-[#041d57] text-white pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center space-y-6 relative z-10">
          <Breadcrumbs
            theme="dark"
            items={[{ label: "Home", href: "/" }, { label: "Integrations", href: "/integrate-with-your-cms" }, { label: "Shopify" }]}
          />
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-tight">
            Shopify Store <span className="text-[#C8FF4D]">ADA &amp; WCAG</span> Compliance
          </h1>
          <p className="text-slate-200 text-lg md:text-xl font-light max-w-2xl leading-relaxed">
            Ensure your e-commerce storefront, product catalog, and checkout journey are accessible to all shoppers while protecting against ADA lawsuits.
          </p>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-3">
            <span className="text-xs font-black tracking-widest text-blue-600 uppercase">Installation Guide</span>
            <h2 className="text-3xl font-black text-slate-900">How to Install on Shopify in 2 Minutes</h2>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-base">Open Shopify Theme Code Editor</h4>
                <p className="text-xs text-slate-600 leading-relaxed mt-1">In your Shopify Admin, go to <strong>Online Store &gt; Themes</strong>. Click the <strong>&quot;...&quot;</strong> icon next to your active theme and select <strong>Edit Code</strong>.</p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div className="space-y-3 flex-1">
                <h4 className="font-extrabold text-slate-900 text-base">Add Script to theme.liquid</h4>
                <p className="text-xs text-slate-600 leading-relaxed">Open <code>Layout/theme.liquid</code>, scroll to the bottom, and paste right before the closing <code>&lt;/body&gt;</code> tag:</p>
            ...
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-base">Click Save</h4>
                <p className="text-xs text-slate-600 leading-relaxed mt-1">Click <strong>Save</strong>. Your store is now equipped with live AI accessibility remediation and Alex virtual assistant.</p>
              </div>
            </div>
          </div>
        </div>
