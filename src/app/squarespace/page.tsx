...
export default function SquarespaceIntegrationPage() {
  ...
  const snippet = `<!-- 2all.ai Accessibility Widget for Squarespace -->
<script 
    ...
    <main className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800">
      ...
      <section className="bg-gradient-to-b from-[#0b3c96] to-[#041d57] text-white pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center space-y-6 relative z-10">
          <Breadcrumbs
            theme="dark"
            items={[{ label: "Home", href: "/" }, { label: "Integrations", href: "/integrate-with-your-cms" }, { label: "Squarespace" }]}
          />
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-tight">
            Squarespace <span className="text-[#C8FF4D]">Accessibility</span> &amp; ADA Conformance
          </h1>
          <p className="text-slate-200 text-lg md:text-xl font-light max-w-2xl leading-relaxed">
            Protect your Squarespace portfolio, blog, or store with single-line script injection and live AI adjustments.
          </p>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-3">
            <span className="text-xs font-black tracking-widest text-blue-600 uppercase">Code Injection</span>
            <h2 className="text-3xl font-black text-slate-900">How to Install on Squarespace</h2>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-base">Open Code Injection Settings</h4>
                <p className="text-xs text-slate-600 leading-relaxed mt-1">In your Squarespace Home Menu, go to <strong>Settings &gt; Developer Tools &gt; Code Injection</strong> (or Advanced &gt; Code Injection).</p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div className="space-y-3 flex-1">
                <h4 className="font-extrabold text-slate-900 text-base">Paste in Footer Section</h4>
                <p className="text-xs text-slate-600 leading-relaxed">Scroll to the <strong>Footer</strong> text box and paste the code:</p>
            ...
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-base">Save and Preview</h4>
                <p className="text-xs text-slate-600 leading-relaxed mt-1">Click <strong>Save</strong> in the top left. The widget will now automatically load for all visitors on your Squarespace site.</p>
              </div>
            </div>
          </div>
        </div>
