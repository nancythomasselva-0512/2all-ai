...
export default function WebflowIntegrationPage() {
  ...
  const snippet = `<!-- 2all.ai Accessibility Widget for Webflow -->
<script 
    ...
    <main className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800">
      ...
      <section className="bg-gradient-to-b from-[#0b3c96] to-[#041d57] text-white pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center space-y-6 relative z-10">
          <Breadcrumbs
            theme="dark"
            items={[{ label: "Home", href: "/" }, { label: "Integrations", href: "/integrate-with-your-cms" }, { label: "Webflow" }]}
          />
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-tight">
            Webflow <span className="text-[#C8FF4D]">Accessibility</span> &amp; WCAG Suite
          </h1>
          <p className="text-slate-200 text-lg md:text-xl font-light max-w-2xl leading-relaxed">
            Enhance your custom Webflow interactions, animations, and typography with automatic WCAG 2.1 AA &amp; ADA remediation.
          </p>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-3">
            <span className="text-xs font-black tracking-widest text-blue-600 uppercase">Webflow Integration</span>
            <h2 className="text-3xl font-black text-slate-900">How to Install on Webflow</h2>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-base">Open Site Settings</h4>
                <p className="text-xs text-slate-600 leading-relaxed mt-1">In your Webflow Workspace, open your project and go to <strong>Project Settings &gt; Custom Code</strong>.</p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div className="space-y-3 flex-1">
                <h4 className="font-extrabold text-slate-900 text-base">Paste in Footer Code</h4>
                <p className="text-xs text-slate-600 leading-relaxed">Scroll to the <strong>Footer Code</strong> section and paste your 2all.ai script:</p>
            ...
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-base">Publish to Domains</h4>
                <p className="text-xs text-slate-600 leading-relaxed mt-1">Click <strong>Save Changes</strong> and publish to your custom domain and Webflow staging subdomain.</p>
              </div>
            </div>
          </div>
        </div>
