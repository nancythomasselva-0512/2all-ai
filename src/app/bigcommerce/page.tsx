...
export default function BigCommerceIntegrationPage() {
  ...
  const snippet = `<!-- 2all.ai Accessibility Widget for BigCommerce -->
<script 
    ...
    <main className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800">
      ...
      <section className="bg-gradient-to-b from-[#0b3c96] to-[#041d57] text-white pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center space-y-6 relative z-10">
          <Breadcrumbs
            theme="dark"
            items={[{ label: "Home", href: "/" }, { label: "Integrations", href: "/integrate-with-your-cms" }, { label: "BigCommerce" }]}
          />
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-tight">
            BigCommerce <span className="text-[#C8FF4D]">Accessibility</span> &amp; ADA Compliance
          </h1>
          <p className="text-slate-200 text-lg md:text-xl font-light max-w-2xl leading-relaxed">
            Protect your BigCommerce enterprise store with automated accessibility adjustments, screen-reader fixes, and WCAG 2.1 AA conformance.
          </p>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-3">
            <span className="text-xs font-black tracking-widest text-blue-600 uppercase">Script Manager Integration</span>
            <h2 className="text-3xl font-black text-slate-900">How to Install in BigCommerce</h2>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-base">Open Script Manager</h4>
                <p className="text-xs text-slate-600 leading-relaxed mt-1">In your BigCommerce control panel, navigate to <strong>Storefront &gt; Script Manager</strong>, and click <strong>Create a Script</strong>.</p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div className="space-y-3 flex-1">
                <h4 className="font-extrabold text-slate-900 text-base">Configure Script Settings</h4>
                <p className="text-xs text-slate-600 leading-relaxed">Set Location to <strong>Footer</strong>, Select pages to <strong>All pages</strong>, and paste the code below into the Script Contents box:</p>
            ...
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-base">Save and Verify</h4>
                <p className="text-xs text-slate-600 leading-relaxed mt-1">Click <strong>Save</strong>. The widget will immediately render across all your storefront pages.</p>
              </div>
            </div>
          </div>
        </div>
