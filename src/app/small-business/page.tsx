        ...
        <section className="bg-[#0a0f1e] text-white py-24 overflow-hidden relative border-t border-white/5">
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10 space-y-16">
            ...
            >
              ...
              <p className="text-slate-200 text-base max-w-xl mx-auto font-normal">Consistently ranked as the leader for Small Businesses on G2 and other leading software review platforms.</p>
            </motion.div>
