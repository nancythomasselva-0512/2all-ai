...
import { Check, Copy, ArrowRight, ShoppingCart, ShieldCheck, Zap } from "lucide-react";

export default function WooCommerceIntegrationPage() {
  const [copied, setCopied] = useState(false);
  const snippet = `<!-- 2all.ai Accessibility Widget for WooCommerce -->
<script 
    ...
    <main className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800">
      ...
      <section className="bg-gradient-to-b from-[#0b3c96] to-[#041d57] text-white pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center space-y-6 relative z-10">
          <Breadcrumbs
            theme="dark"
            items={[{ label: "Home", href: "/" }, { label: "Integrations", href: "/integrate-with-your-cms" }, { label: "WooCommerce" }]}
          />
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-tight">
            WooCommerce <span className="text-[#C8FF4D]">Store Accessibility</span> &amp; ADA Shield
          </h1>
          <p className="text-slate-200 text-lg md:text-xl font-light max-w-2xl leading-relaxed">
            Ensure product filters, add-to-cart flows, checkout gateways, and shopping cart drawers are fully accessible and compliant with WCAG 2.1 AA.
          </p>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-3">
            <span className="text-xs font-black tracking-widest text-blue-600 uppercase">WordPress / WooCommerce</span>
            <h2 className="text-3xl font-black text-slate-900">How to Install on WooCommerce</h2>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-base">Generate 2all.ai Widget Key</h4>
                <p className="text-xs text-slate-600 leading-relaxed mt-1">Add your WooCommerce domain in your 2all.ai dashboard and copy your custom asynchronous loader tag.</p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div className="space-y-3 flex-1">
                <h4 className="font-extrabold text-slate-900 text-base">Embed into wp_footer or Snippet Manager</h4>
                <p className="text-xs text-slate-600 leading-relaxed">Paste this code in your child theme <code>functions.php</code> or using the free <strong>WPCode plugin</strong>:</p>
            ...
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-base">Verify Live Store</h4>
                <p className="text-xs text-slate-600 leading-relaxed mt-1">Visit your store. The 2all.ai accessibility tools and Alex AI assistant will immediately be active across all product categories and checkout pages.</p>
              </div>
            </div>
          </div>
        </div>
