...
import { 
  ...
  Palette, Bot, Settings, Search, RefreshCcw
} from "lucide-react";
      ...
      <div className="px-6 pt-6 pb-4 border-b border-slate-200/50 shrink-0 bg-white/50 backdrop-blur-md relative z-10">
        ...
        <div className="relative">
          ...
          <input 
            ...
            className="w-full bg-white/80 border border-slate-200 rounded-xl py-2.5 pl-10 pr-4 text-sm font-semibold text-[#0a1e3f] outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all shadow-inner"
          />
        </div>
      </div>
